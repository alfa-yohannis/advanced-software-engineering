...
\caption{Model variasi environment dengan pola inheritance: setiap environment mewarisi \textit{defaults} dan hanya mengisi nilai override yang diperlukan.}
\label{fig:mde-models-inheritance}
\end{figure}
