...
\begin{enumerate}
  ...
  \item Mengimplementasikan server MCP modular untuk domain spesifik --- pembaca data jadwal, otomasi browser, dan \textit{shared state} --- menggunakan Python dan library \texttt{FastMCP}.
  \item Menganalisis \textit{trade-off} antara pendekatan agen tunggal dan multi-agen dalam hal skalabilitas, keandalan (\textit{reliability}), efisiensi konteks, dan kemampuan penalaran visual.
\end{enumerate}
