...
- [src/media-flow.langium](src/media-flow.langium) -  The grammar definition of your language
- [src/media-flow-module.ts](src/media-flow-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/media-flow-validator.ts](src/media-flow-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/media-flow.monarch.ts](src/syntaxes/media-flow.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/media-flow.tmLanguage.json](syntaxes/media-flow.tmLanguage.json) - Textmate based syntax highlighting instructions.
