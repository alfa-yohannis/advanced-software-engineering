...
/**
 * This is the item provider adapter for a {@link mediaflow.Resource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceItemProvider extends NodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resource_mediaType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resource_mediaType_feature", "_UI_Resource_type"),
				 MediaflowPackage.Literals.RESOURCE__MEDIA_TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MediaflowPackage.Literals.RESOURCE__URI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addExternalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resource_external_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resource_external_feature", "_UI_Resource_type"),
				 MediaflowPackage.Literals.RESOURCE__EXTERNAL,
				 true,
				 false,
				 false,
